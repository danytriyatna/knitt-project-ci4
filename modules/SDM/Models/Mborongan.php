...
class Mborongan extends \App\Models\PrModel
{
    ...
    function getData($id = null, $offset = null, $limit = null, $order = null, $filters = null, $params = null)
    {
        ...
        $builder->select("tp.keterangan_style, rp.nama_operator, pd.id_proses, pd.id_operator, jp.nama as proses, 
        ...
        if ($id == null or $id == "") {
            ...
            $builder->groupBy("tp.keterangan_style, rp.nama_operator, pd.id_proses, pd.id_operator, jp.nama");
