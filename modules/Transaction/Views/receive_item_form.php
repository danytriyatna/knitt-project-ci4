  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          <label class="control-label text-start text-md-end col-md-2 col-form-label" for="nilai_item">Nilai</label>
          <div class="col-md-9">
            <input type="text" id="nilai_item" name="nilai_item" class="form-control" placeholder="Ketikkan nilai item" value="100">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input type="text" id="receive_no" name="receive_no" class="form-control" placeholder="Ketikkan Receive No." value="TRF24100001">
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group row">
                    <label class="control-label text-start text-md-end col-md-4 col-form-label" for="receive_date">Receive Date</label>
                    <div class="col-md-8">
                      <input type="text" id="receive_date" name="receive_date" class="form-control datepicker" placeholder="Pilih tanggal receive" value="01 November 2024">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="row">
                <div class="col-sm-10">
                  <a href="trans/receive-item" class="btn btn-default m-e-5">
                    <span class="fa fa-arrow-left"></span> Kembali
                  </a>
                  <a href="trans/receive-item" class='btn btn-success'>
