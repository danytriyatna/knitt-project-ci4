                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                        <input <?= ($disabled_input)? 'disabled' : '' ?> type="text" id="tgl_cr" name="tgl_cr" class="form-control datepicker" placeholder="Pilih tanggal CR" value="<?= !empty($row->tgl_transaksi)? $row->tgl_transaksi : '' ?>">
                      </div>
                    </div>
                  </div>
                </div>
