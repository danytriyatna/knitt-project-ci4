              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input type="text" id="tanggal" name="tanggal" class="form-control datepicker" placeholder="Pilih tanggal transfer" value="<?= !empty($resData->tanggal) ? $resData->tanggal : date("d F Y", now()) ?>">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-sm-12 mb-2">
            <!-- <button type="button" class="btn btn-sm btn-primary" id="btn-view"> <i class="fa fa-plus"></i></button> -->
             <div class="input-group my-2">
                ...
                <button  <?=  !empty($role_id) && ($role_id == 1 || $role_id == 2) ? null : 'hidden' ?> type="button" class="btn btn-info text-white" id="btn-view"><i class="fa fa-plus"></i></button> 
              </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
