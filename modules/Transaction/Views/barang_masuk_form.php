    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row mb-3">
          ...
          <div class="col-md-9">
            <select id="pack_id" name="pack_id" class="form-select select2" data-placeholder="-- Pilih Pack --">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12 mb-3">
            <div class="col-md-4" style="float: right; position: relative; right: 15px;">
              <div class="homeSearch w-100" style="width: 100%; margin-left: 5%; margin-top: 0;">
                <input type="text" id="tb-search-barang" class="form-control" placeholder="Pencarian . . .">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12 mb-3">
            <div class="col-md-4" style="float: right; position: relative; right: 15px;">
              <div class="homeSearch w-100" style="width: 100%; margin-left: 5%; margin-top: 0;">
                <input type="text" id="tb-search-po" class="form-control" placeholder="Pencarian . . .">
              </div>
            </div>
          </div>
        </div>
...
<?= $this->section('script'); ?>
<script src="script/app/transaction/barang_masuk/form.js"></script>
