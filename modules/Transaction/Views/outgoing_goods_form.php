            ...
            <div class="col-sm-8">
              <div class="row">
                ...
                <div class="form-group row d-none" id="divStokGudangAsal">
                  <label class="control-label text-start text-md-end col-md-3 col-form-label" for="stok">Stok Gudang Tujuan<span class="text-danger">*</span></label>
                  <div class="col-md-4">
                    <div class="input-group">
                      <input type="text" class="form-control" id="stok_tujuan" name="stok_tujuan" placeholder="Stok Otomatis" disabled>
                    </div>
                    <div class="invalid-feedback">
                      Stok Gudang Tujuan tidak valid
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label text-start text-md-end col-md-3 col-form-label" for="stok">Jumah Keluar<span class="text-danger">*</span></label>
                  <div class="col-md-4">
                    <input type="number" id="jml_keluar" name="jml_keluar" class="form-control" placeholder="Ketikkan Jumlah Keluar" required>
                  </div>
                  <div class="invalid-feedback">
                    Jumlah Keluar valid
                  </div>
...
<?= $this->section('script'); ?>
<script src="script/app/transaction/outgoing_goods/form.js"></script>
