              ...
              <thead>
                <tr>
                  <th style="min-width: 105px; width: 105px;">
                    <a href="trans/issue-item/form" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a>
                  </th>
                  <th>GI NO.</th>
                  <th>GI DATE</th>
                  <th>REF NO.</th>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-menu-act" role="menu">
                        <li><a href="trans/issue-item/form" title="Edit"><i class="fa fa-fw fa-edit"></i> Edit</a></li>
