          ...
          <div class="row">
            <div class="col-sm-7">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input type="text" id="trans_no" name="trans_no" class="form-control" placeholder="Ketikkan Trans No." value="TRF24100001">
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group row">
                    <label class="control-label text-start text-md-end col-md-4 col-form-label" for="trans_po">Date</label>
                    <div class="col-md-8">
                      <input type="text" id="trans_po" name="trans_po" class="form-control datepicker" placeholder="Pilih tanggal transfer" value="01 November 2024">
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group row">
                    <label class="control-label text-start text-md-end col-md-3 col-form-label" for="transfer_from">Transfer From</label>
                    <div class="col-md-9">
                      <select id="transfer_from" name="transfer_from" class="form-select select2" data-placeholder="-- Pilih Gudang --">
                ...
                <div class="col-sm-6">
                  <div class="form-group row">
                    <label class="control-label text-start text-md-end col-md-4 col-form-label" for="transfer_to">Transfer To</label>
                    <div class="col-md-8">
                      <select id="transfer_to" name="transfer_to" class="form-select select2" data-placeholder="-- Pilih Gudang --">
                        <option value="1">GUDANG UTAMA</option>
                        <option value="2" selected>GUDANG PRODUKSI</option>
                      </select>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-sm-12">
              ...
              <div class="row">
                <div class="col-sm-10">
                  ...
                  <a href="trans/item-transfer" class='btn btn-success'>
