...
class OutgoingGoods extends BaseController
{
    ...
    public function index()
    {
        ...
        return view($this->views . '\outgoing_goods_list', $this->data);
    }
    ...
    public function lists()
    {
        ...
        foreach ($results as $row) {
            ...
            if ($row->id_kategori == 4) {
                $informasi = "Gudang Asal: $row->gudang_asal<br>";
                $informasi .= "Gudang Tujuan: $row->gudang_tujuan";
            } else if ($row->id_kategori == 5) {
                $informasi = "Gudang Asal: $row->gudang_asal<br>";
                $informasi .= "Nama: $row->nama";
            } else if ($row->id_kategori == 6) {
                $informasi = "Gudang Asal: $row->gudang_asal<br>";
                $informasi .= "Pelanggan: $row->nama";
            } else if ($row->id_kategori == 7) {
                $informasi = "Gudang Asal: $row->gudang_asal<br>";
            } else if ($row->id_kategori == 8) {
                $informasi = "Gudang Asal: $row->gudang_asal<br>";
