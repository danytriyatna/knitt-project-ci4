...
class PurchaseDetailModel extends \App\Models\PrModel
{
    ...
    function getData($id = null, $offset = null, $limit = null, $order = null, $filters = null, $params = null)
    {
        ...
        $builder->select("uk.id, uk.id_header,uk.qty,uk.qty_receive, uk.id_barang,uk.disc_price,uk.tax_price,fbx.nama_satuan as nama_unit, ebx.kode_barang, ebx.nama_barang,uk.tax,uk.disc,uk.price,uk.grand_price");
