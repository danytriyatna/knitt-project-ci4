              ...
              <thead>
                <tr>
                  <th style="min-width: 105px; width: 105px;">
                    <a href="purchasing/purchase-payment/form" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a>
                  </th>
                  <th>PP NO.</th>
                  <th>PP DATE</th>
                  <th>VENDOR</th>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-menu-act" role="menu">
                        <li><a href="purchasing/purchase-payment/form" title="Edit"><i class="fa fa-fw fa-edit"></i> Edit</a></li>
