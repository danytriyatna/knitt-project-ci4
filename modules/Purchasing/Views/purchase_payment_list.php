      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-sm-3">
              <a href="purchasing/purchase-payment/form" type="button" class="btn btn-sm btn-success" id="btn-add"> <i class="fa fa-plus"></i> Tambah</a>
            </div>
...
<?= $this->section('script'); ?>
<script src="script/app/purchasing/payment/index.js"></script>
