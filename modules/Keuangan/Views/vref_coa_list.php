      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-sm-3">
                <a href="<?= base_url(); ?>/keuangan/daftar_akun/add" class="btn btn-primary open_form" type="button"><i class="fa fa-plus"></i>
                Tambah</a>
            </div>
...
<?= $this->section('script'); ?>
<script src="script/app/keuangan/daftar_akun/index.js"></script>
