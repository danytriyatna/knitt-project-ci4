...
class RefJenisBarang extends BaseController
{
    protected $mJenisBarang;

    protected $views = '\Modules\Referensi\Views';
    protected $urlv  = 'master-data/jenis_barang';

    function __construct()
    {
        $this->MOD_ALIAS = "MOD_REFERENSI_JENIS_BARANG";
    ...
    public function index()
    {
        ...
        $this->data['titlehead'] = "Master Data Jenis Barang";

        return view($this->views . '\jenis_barang\index', $this->data);
    }
    ...
    public function lists()
    {
        ...
        $results = $this->mJenisBarang->getData(null, $start, $limit, $order, $filters, $params);
        $totalfiltered = $this->mJenisBarang->getDataCnt($filters, $params);
        $totaldata = $this->mJenisBarang->getDataCnt(null, $params);
    ...
    function save()
    {
        ...
        if (empty($id)) {
            ...
            $this->mJenisBarang->insertRecordGetid($this->mJenisBarang->table, $arr_isi);
            ...
            $id = decrypt($id);
            $this->mJenisBarang->updateRecord($this->mJenisBarang->table, $arr_isi, 'id', $id);
    ...
    public function activate($id)
    {
        ...
        $id = (int)$id;
        $activation = $this->mJenisBarang->activate($id);
        if ($activation) {
