...
class RefSatuan extends BaseController
{
    protected $mSatuan;

    protected $views = '\Modules\Referensi\Views';
    protected $urlv  = 'master-data/satuan';

    function __construct()
    {
        $this->MOD_ALIAS = "MOD_REFERENSI_SATUAN";
    ...
    public function index()
    {
        ...
        $this->data['titlehead'] = "Master Data Satuan";

        return view($this->views . '\satuan\index', $this->data);
    }
    ...
    public function lists()
    {
        ...
        $results = $this->mSatuan->getData(null, $start, $limit, $order, $filters, $params);
        $totalfiltered = $this->mSatuan->getDataCnt($filters, $params);
        $totaldata = $this->mSatuan->getDataCnt(null, $params);
    ...
    function save()
    {
        ...
        if (empty($id)) {
            $this->mSatuan->insertRecordGetid($this->mSatuan->table, $arr_isi);
            $msg    = "Data berhasil ditambahkan !";
            $status = true;
        } else {
            $id = decrypt($id);
            $this->mSatuan->updateRecord($this->mSatuan->table, $arr_isi, 'id', $id);
    ...
    public function activate($id)
    {
        ...
        $id = (int)$id;
        $activation = $this->mSatuan->activate($id);
        if ($activation) {
