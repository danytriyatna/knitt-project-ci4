  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          <label class="control-label text-start text-md-end col-md-2 col-form-label" for="no_hp">No Handphone<span class="text-danger">*</span></label>
          <div class="col-md-9">
            <input type="text" id="no_hp" name="no_hp" class="form-control" placeholder="Ketik No Handphone" required>
            <div class="invalid-feedback">
        ...
        <div class="form-group row">
          <label class="control-label text-start text-md-end col-md-2 col-form-label" for="harga">Harga<span class="text-danger">*</span></label>
          <div class="col-md-9">
            <input type="text" id="harga" name="harga" pattern="\d{10,13}" class="form-control" placeholder="Ketik No Harga" required>
            <div class="invalid-feedback">
              Harga tidak valid
            </div>
          </div>
...
<?= $this->section('script'); ?>
<script src="script/app/referensi/operator/index.js"></script>
