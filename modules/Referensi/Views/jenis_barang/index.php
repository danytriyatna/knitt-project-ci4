  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Form Master Jenis Barang</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          <label class="control-label text-start text-md-end col-md-2 col-form-label" for="nama_jenis_barang">Nama Jenis Barang<span class="text-danger">*</span></label>
          <div class="col-md-9">
            <input type="text" id="nama_jenis_barang" name="nama_jenis_barang" class="form-control" placeholder="Ketik Nama Jenis Barang" required>
            <div class="invalid-feedback">
              Nama Jenis Barang tidak valid
            </div>
          </div>
        </div>
        <div class="form-group row">
...
<?= $this->section('script'); ?>
<script src="script/app/referensi/jenis_barang/index.js"></script>
