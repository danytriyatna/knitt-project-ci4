  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Form Master Satuan</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          <label class="control-label text-start text-md-end col-md-2 col-form-label" for="nama_satuan">Nama Satuan<span class="text-danger">*</span></label>
          <div class="col-md-9">
            <input type="text" id="nama_satuan" name="nama_satuan" class="form-control" placeholder="Ketik Nama Satuan" required>
            <div class="invalid-feedback">
              Nama Satuan tidak valid
            </div>
          </div>
        </div>
        <div class="form-group row">
...
<?= $this->section('script'); ?>
<script src="script/app/referensi/satuan/index.js"></script>
