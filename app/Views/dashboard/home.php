...
/* Tambahkan pseudo-element untuk watermark */
.watermark-bg::before {
  content: "";
  position: absolute;
  top: 35%;
  ...
  background-size: contain; /* bisa 'cover' jika mau penuh */
  transform: translate(-50%, -50%);
  z-index: 0;
}

/* Supaya konten tetap di atas watermark */
.watermark-bg > * {
  position: relative;
  z-index: 1;
}
  ...
  <div class="container-fluid">
    ...
    <div class="row watermark-bg" style="min-height: 1000px;">
