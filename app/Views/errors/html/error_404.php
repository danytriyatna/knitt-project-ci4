  ...
  <link href="assets/css/custom.min.css" rel="stylesheet">
	...
	<style>
		...
		.dark .container-fluid {
			...
			background-image: url("<?= base_url(); ?>/assets/images/error-img.webp");
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col">
				...
				<h1 class="f-s-36 m-b-10">Halaman Tidak Ditemukan 😓</h1>
				<h3 class="f-w-400 m-t-0 m-b-15">Kelihatannya alamat yang kamu tuju tidak ditemukan.</h3>
				<?php if (! empty($message) && $message !== '(null)') : ?>
					<h5 class="f-w-400 m-t-0 m-b-15"><em><?= esc($message) ?></em></h5>
				<?php endif ?>
				<br>
				<a class="error-cta" href="./">Kembali ke Halaman Utama</a>
			</div>
		</div>
	</div>
