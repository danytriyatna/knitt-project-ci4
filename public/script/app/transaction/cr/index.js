$(document).ready(function () {
    let dtList = new Tabulator("#dt-list", {
        columns: [
			...
			{
				title: 'CR No.', field: 'kode_cr', headerSort:false, sorter: 'string',
            ...
            {
				title: 'Buyer', field: 'nama_konsumen', headerSort:false, sorter: 'string',
				formatter : "html"
			},

            {
				title: 'Bank', field: 'rekening_bank', headerSort:false, sorter: 'string',
				width: 160, align:'center',
			},

            {
				title: 'PPH', field: 'pph', formatter : "money", headerSort:false, sorter: 'string',
				width: 160, align:'center', cssClass:'text-end'
			} ,

            {
				title: 'Total Bayar', field: 'total_bayar', headerSort:false, sorter: 'string', align: "center",
        ...
        layout: 'fitColumns',
        ajaxURL: "/trans/customer-receipt/list",
