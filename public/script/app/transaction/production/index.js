$(document).ready(function () {
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-3 text-start">
                        <h6 class="f-w-700 m-b-6">${data.kode_prod}</h6>
                        <p class="f-w-500 m-y-0">${data.ref_kode}</p>
                        <p class="f-w-500 m-y-0">${data.kode_walkorder_ref}</p>
                        ...
                        <a class="hover-zoom-rotate" href="${data.file_name}" target="_blank"><img class="m-t-0 d-block object-fit-cover rounded" src="${data.file_gambar}" alt="Foto Sample" width="160px" height="90px" /></a>
                      </div>
                      <div class="col-sm-9">
	...
	// 		{
	// 			title: 'No. Production', field: 'kode_prod', headerSort:false, sorter: 'string',
